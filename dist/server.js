...
var verify_1 = __importDefault(require("./middlewares/verify"));
var socket_io_1 = __importDefault(require("socket.io"));
var socket_1 = __importDefault(require("./socket"));
var user_routes_1 = __importDefault(require("./routes/user.routes"));
var private_routes_1 = __importDefault(require("./routes/private.routes"));
var Server = /** @class */ (function () {
    ...
    Server.prototype.middlewares = function () {
        ...
        passport_1.default.use(verify_1.default);
    };
    Server.prototype.routes = function () {
        this.server.use('/api', user_routes_1.default);
        this.server.use('/api', private_routes_1.default);
    };
    Server.prototype.staticFiles = function () {
        ...
        this.server.use('uploads', express_1.default.static(path_1.default.resolve('uploads')));
    };
    Server.prototype.listen = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.server.listen(this.server.get('port'))];
                    case 1:
                        server = _a.sent();
